...
describe('Game3', function () {
  ...
  it('should be a winner', async function () {
    const { game, signer_1, signer_2, signer_3 } = await loadFixture(deployContractAndSetVariables);
    ...
    const address_2 = await signer_2.getAddress(); console.log(address_2)
    const address_3 = await signer_3.getAddress(); console.log(address_3)
